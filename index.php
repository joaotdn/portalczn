      ...
      <div class="row">
        ...
        <div class="small-16 medium-16 large-12 left the-content">
            ...
            <nav class="small-16 left nav-news">
              ...
              >
                <li class="small-16 left">
                  ...
                  <p class="text-except show-for-medium-up">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Temporibus, dolore, ipsa eaque porro ea corporis sint optio quia rem...</p>
                  <p><a href="#" title="" class="font-header color-body"><span class="icon-comment hack-icon"></span> 9 comentários</a></p>
                </li>
          ...
          <section class="box-container small-16 left">
            <div class="small-16 columns">
              <header class="box-header small-16 left">
                <h3 class="top-header left"><a href="#" title="" class="red text-up"><span class="icon-folder"></span> Política</a></h3>
                <h4>
            ...
            <div class="small-16 medium-8 large-8 columns box-td">
              <figure class="small-5 medium-7 large-7 left th mbt">
          ...
          <section class="small-16 medium-10 large-11 columns mbt mtp">
            <header class="small-16 left box-header">
              <h3 class="top-header left">
                <a href="#" title="" class="red text-up"><span class="icon-folder"></span> Policial</a>
              </h3>
              <h4>
                <a href="#" class="see-more" title="Veja mais"><span class="right icon-list"></span></a>
              </h4>
            ...
            <div class="box-td left small-16">
              ...
              <article class="small-12 left ads-in-left">
                <small class="font-header red tag">Bate-boca</small>
                <h4><a href="#" title="">Necessitatibus, repellendus, maxime, et ab deserunt at eum sit ex alias dolor rem natus ipsam</a></h4>
                <p class="text-except show-for-large-up">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit, illum consequuntur...</p>
                <p class="font-header"><a href="#" title="" class="color-body"><span class="icon-comment hack-icon"></span> 3 comentários</a></p>
              </article>
              ...
              <article class="small-16 left box-list">
                <h5>
                  <a href="#" title="" class="font-header display-tb">
                    ...
                    <span class="pl display-tbc">Perspiciatis ut recusandae sint rem sit repudiandae placeat aut harum</span>
                  </a>
                </h5>
              </article> 
            </div>
          ...
          <section class="small-16 medium-8 large-8 columns mbt">
            <header class="small-16 left box-header">
              <h3 class="top-header left">
                <a href="#" title="" class="red text-up"><span class="icon-folder"></span> Cajazeiras</a>
              </h3>
              <h4>
                <a href="#" class="see-more" title="Veja mais"><span class="right icon-list"></span></a>
              </h4>
          ...
          <section class="small-16 medium-8 large-8 columns box-in-list">
            <header class="small-16 left box-header">
              <h3 class="top-header left">
                <a href="#" title="" class="red text-up"><span class="icon-folder"></span> Cidades</a>
              </h3>
              <h4>
                <a href="#" class="see-more" title="Veja mais"><span class="right icon-list"></span></a>
              </h4>
          ...
          <section class="videos small-16 medium-10 large-10 columns mbt">
            <header class="small-16 left box-header">
              <h3 class="top-header left">
                <a href="#" title="" class="red text-up"><span class="icon-video"></span> Vídeos</a>
              </h3>
              <h4>
                <a href="#" class="see-more" title="Veja mais"><span class="right icon-list"></span></a>
              </h4>
                ...
                <figure class="small-16 left rel video-thumb" data-reveal-id="video-modal">
                  ...
                  <figcaption class="small-16 abs">
                    <div class="abs play-video small-16">
                      ...
                      <h4 class="white columns">Lorem ipsum dolor sit amet, consectetur adipisicing elit</h3>
                    </div>
                  </figcaption>
                </figure>
